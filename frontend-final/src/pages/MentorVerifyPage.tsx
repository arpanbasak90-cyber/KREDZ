      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {!isLoggedInMentor ? (
          ...
          <div className="bg-gradient-card rounded-2xl border border-border/60 p-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Review the checkpoints above marked <span className="font-semibold text-foreground">"needs your review"</span>.
              ...
              <div>
                <p className="text-sm font-semibold">
                  ...
                  <span className="text-xs font-normal text-muted-foreground">
                    {cp.status === "auto_cleared" ? "— cleared by AI" : "— needs your review"}
                  </span>
                </p>
